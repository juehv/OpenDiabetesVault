...
public class PlotteriaConfig {
    ...
    private double glucoseElevationN1 = 0;
    private double glucoseElevationN2 = 25;
    private double glucoseElevationN3 = 50;

    private double legendXOffset = -0.05;
    private double legendYOffset = 0.295;
    
    private int mlCgmArrayIndex = 1;
    ...
    private boolean plotElevation = true;
    ...
    private String glucoseElevationColor = "#122313";
    ...
    private String lowElevationUpLegend = "elevation > " + glucoseElevationN1;
    private String midElevationUpLegend = "elevation > " + glucoseElevationN2;
    private String highElevationUpLegend = "elevation > " + glucoseElevationN3;
    private String lowElevationDownLegend = "elevation <= " + glucoseElevationN1;
    private String midElevationDownLegend = "elevation <= -" + glucoseElevationN2;
    private String highElevationDownLegend = "elevation <= -" + glucoseElevationN3;
    ...
    private int cgmAdditionalMarkerSize = 5;
    private int cgmMainMarkerSize = 7;
    ...
    // daily statistics
    private int maxLengthNotes = 400;
    private String labelTimeInRange = "Time in range";
    private String labelHypo = "Hypo";
    private String labelHyper = "Hyper";
    private String labelBasalTotal = "Basal Total";
    private String labelBolusTotal = "Bolus Total";
    private String labelCarbTotal = "Carb Total";
    private String labelAutonomousSuspentionTime = "Autonomous Suspension Time";
    private String labelNote = "Note";
    private String colorTimeInRange = "#7676EE";
    private String colorHyper = "#EED376";
    private String colorHypo = "#EED376";
    private String colorNone = "#AAAAAA";
	...
	public double getGlucoseElevationN1() {
		return glucoseElevationN1;
	}
	public void setGlucoseElevationN1(double glucoseElevationN1) {
		this.glucoseElevationN1 = glucoseElevationN1;
	}
	public double getGlucoseElevationN2() {
		return glucoseElevationN2;
	}
	public void setGlucoseElevationN2(double glucoseElevationN2) {
		this.glucoseElevationN2 = glucoseElevationN2;
	}
	public double getGlucoseElevationN3() {
		return glucoseElevationN3;
	}
	public void setGlucoseElevationN3(double glucoseElevationN3) {
		this.glucoseElevationN3 = glucoseElevationN3;
	}
	...
	public int getMlCgmArrayIndex() {
		return mlCgmArrayIndex;
	}
	public void setMlCgmArrayIndex(int mlCgmArrayIndex) {
		this.mlCgmArrayIndex = mlCgmArrayIndex;
	}
	...
	public boolean isPlotElevation() {
		return plotElevation;
	}
	public void setPlotElevation(boolean plotElevation) {
	...
	public String getGlucoseElevationColor() {
		return glucoseElevationColor;
	}
	public void setGlucoseElevationColor(String glucoseElevationColor) {
		this.glucoseElevationColor = glucoseElevationColor;
	}
	...
	public String getLowElevationUpLegend() {
		return lowElevationUpLegend;
	}
	public void setLowElevationUpLegend(String lowElevationUpLegend) {
		this.lowElevationUpLegend = lowElevationUpLegend;
	}
	public String getMidElevationUpLegend() {
		return midElevationUpLegend;
	}
	public void setMidElevationUpLegend(String midElevationUpLegend) {
		this.midElevationUpLegend = midElevationUpLegend;
	}
	public String getHighElevationUpLegend() {
		return highElevationUpLegend;
	}
	public void setHighElevationUpLegend(String highElevationUpLegend) {
		this.highElevationUpLegend = highElevationUpLegend;
	}
	public String getLowElevationDownLegend() {
		return lowElevationDownLegend;
	}
	public void setLowElevationDownLegend(String lowElevationDownLegend) {
		this.lowElevationDownLegend = lowElevationDownLegend;
	}
	public String getMidElevationDownLegend() {
		return midElevationDownLegend;
	}
	public void setMidElevationDownLegend(String midElevationDownLegend) {
		this.midElevationDownLegend = midElevationDownLegend;
	}
	public String getHighElevationDownLegend() {
		return highElevationDownLegend;
	}
	public void setHighElevationDownLegend(String highElevationDownLegend) {
		this.highElevationDownLegend = highElevationDownLegend;
	}
	...
	public int getCgmAdditionalMarkerSize() {
		return cgmAdditionalMarkerSize;
	}
	public void setCgmAdditionalMarkerSize(int cgmAdditionalMarkerSize) {
		this.cgmAdditionalMarkerSize = cgmAdditionalMarkerSize;
	}
	public int getCgmMainMarkerSize() {
		return cgmMainMarkerSize;
	}
	public void setCgmMainMarkerSize(int cgmMainMarkerSize) {
		this.cgmMainMarkerSize = cgmMainMarkerSize;
	}
	...
	public int getMaxLengthNotes() {
		return maxLengthNotes;
	}
	public void setMaxLengthNotes(int maxLengthNotes) {
		this.maxLengthNotes = maxLengthNotes;
	}
	public String getLabelTimeInRange() {
		return labelTimeInRange;
	}
	public void setLabelTimeInRange(String labelTimeInRange) {
		this.labelTimeInRange = labelTimeInRange;
	}
	public String getLabelHypo() {
		return labelHypo;
	}
	public void setLabelHypo(String labelHypo) {
		this.labelHypo = labelHypo;
	}
	public String getLabelHyper() {
		return labelHyper;
	}
	public void setLabelHyper(String labelHyper) {
		this.labelHyper = labelHyper;
	}
	public String getLabelBasalTotal() {
		return labelBasalTotal;
	}
	public void setLabelBasalTotal(String labelBasalTotal) {
		this.labelBasalTotal = labelBasalTotal;
	}
	public String getLabelBolusTotal() {
		return labelBolusTotal;
	}
	public void setLabelBolusTotal(String labelBolusTotal) {
		this.labelBolusTotal = labelBolusTotal;
	}
	public String getLabelCarbTotal() {
		return labelCarbTotal;
	}
	public void setLabelCarbTotal(String labelCarbTotal) {
		this.labelCarbTotal = labelCarbTotal;
	}
	public String getLabelAutonomousSuspentionTime() {
		return labelAutonomousSuspentionTime;
	}
	public void setLabelAutonomousSuspentionTime(
			String labelAutonomousSuspentionTime) {
		this.labelAutonomousSuspentionTime = labelAutonomousSuspentionTime;
	}
	...
	public String getColorTimeInRange() {
		return colorTimeInRange;
	}
	public void setColorTimeInRange(String colorTimeInRange) {
		this.colorTimeInRange = colorTimeInRange;
	}
	public String getColorHyper() {
		return colorHyper;
	}
	public void setColorHyper(String colorHyper) {
		this.colorHyper = colorHyper;
	}
	public String getColorHypo() {
		return colorHypo;
	}
	public void setColorHypo(String colorHypo) {
		this.colorHypo = colorHypo;
	}
	public String getColorNone() {
		return colorNone;
	}
	public void setColorNone(String colorNone) {
