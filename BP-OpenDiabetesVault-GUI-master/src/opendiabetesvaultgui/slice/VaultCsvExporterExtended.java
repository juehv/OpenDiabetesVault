...
import static de.opendiabetes.vault.plugin.common.OpenDiabetesPlugin.LOG;
 ...
 * @author Daniel
 */
public class VaultCsvExporterExtended extends VaultExporter {

    private List<de.opendiabetes.vault.container.VaultEntry> delayBuffer;
    ...
    private de.opendiabetes.vault.container.csv.VaultCSVEntry processVaultEntry(de.opendiabetes.vault.container.csv.VaultCSVEntry csvEntry, de.opendiabetes.vault.container.VaultEntry entry) {
//            VaultCSVEntry tmpCsvEntry = vaultCsvEntry;        
        switch (entry.getType()) {
            ...
            case KETONES_URINE:
                ...
                break;
            default:
                LOG.severe("TYPE ASSERTION ERROR!" + entry.getType());
            ...
            for (VaultEntryAnnotation annotation : entry.getAnnotations()) {
                switch (annotation.getType()) {
                    ...
                    case MEAL_Information:
                        ...
                        break;
                    default:
                        LOG.severe("ANNOTATION ASSERTION ERROR!" + annotation.getType());
                    //throw new AssertionError();
                }
            }
        }
