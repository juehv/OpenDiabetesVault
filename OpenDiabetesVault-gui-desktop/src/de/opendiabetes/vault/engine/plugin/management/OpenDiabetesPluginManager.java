 ...
 */
package de.opendiabetes.vault.engine.plugin.management;

import de.opendiabetes.vault.engine.plugin.common.OpenDiabetesPlugin;
...
public final class OpenDiabetesPluginManager {
     ...
     */
    private static OpenDiabetesPluginManager INSTANCE = null;
    // HAck to fix this bad implementation design ... :(
     ...
     * @return the Singleton OpenDiabetesPluginManager instance
      */
    public static OpenDiabetesPluginManager getInstance() throws URISyntaxException {
        if (INSTANCE == null) {
...
//            basedir =  basedir.getParent().getParent().getParent().getParent().getParent().getParent().getParent().getParent();
            ...
            basedir = Paths.get(new URI(PLUGIN_PATH));
            INSTANCE = new OpenDiabetesPluginManager(basedir.resolve("export"), basedir.resolve("properties"));
        }
        return  INSTANCE;
    }
