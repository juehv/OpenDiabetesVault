...
import static de.opendiabetes.vault.gui.launcher.FatherController.LANGUAGE_NAME;
...
public class OptionsWindowController extends FatherController implements Initializable {
    ...
    private void applyChanges(ActionEvent event) throws MalformedURLException {
        ...
        dialogPane.getStylesheets().add(
                getClass().getResource(FatherController.STYLESHEET_PATH+"/alertStyle.css").toExternalForm());
