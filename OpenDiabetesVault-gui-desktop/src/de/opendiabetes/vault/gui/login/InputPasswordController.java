...
public class InputPasswordController extends FatherController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // load specific font
        Font.loadFont(InputPasswordController.class.getResource(FatherController.STYLESHEET_PATH+"/fonts/Roboto-Thin.ttf").toExternalForm(), 50);
        Font.loadFont(InputPasswordController.class.getResource(FatherController.STYLESHEET_PATH+"/fonts/Roboto-Regular.ttf").toExternalForm(), 50);
